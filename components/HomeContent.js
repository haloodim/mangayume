    ...
    <main className="container mx-auto p-4">
      <div className="bg-gray-800 p-2 sm:p-6 md:p-6 rounded-lg shadow-lg mx-0 sm:mx-4 md:mx-20 lg:mx-40 ">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          ...
          {/* Repeating the same structure for the rest */}
          <div className="flex flex-col items-center text-center">
            <Link href="/deskripsi" className="image-hover">
              <img
                alt="Cover of I Took Over The System Players Manga"
                ...
                src="https://cdn.manhwature.com/resize/240/346/apkomik.cc/wp-content/uploads/2024/12/1dd3a9a3dfa94d21a4cc3a4f031cf349tplv-scl3phc04j-image.jpeg"
              />
              <div className="absolute top-0 left-0 bg-blue-500 text-white text-xs font-bold px-2 py-1 rounded-br-lg">Manhwa</div>
              <div className="absolute bottom-2 right-2 flex items-center">
            ...
            <button className="mt-2 border border-white text-white py-1 px-2 rounded-full text-[13px] w-full flex justify-between hover:border-blue-500 hover:text-blue-500">
              <span>Ch. 128</span>
              <span>1 jam lalu</span>
            </button>
            <Link
          ...
          <div className="flex flex-col items-center text-center">
            <Link href="/deskripsi" className="image-hover">
              <img
                ...
                src="https://cdn.manhwature.com/resize/240/346/apkomik.cc/wp-content/uploads/2024/12/1dd3a9a3dfa94d21a4cc3a4f031cf349tplv-scl3phc04j-image.jpeg"
              />
              <div className="absolute top-0 left-0 bg-green-500 text-white text-xs font-bold px-2 py-1 rounded-br-lg">Manhua</div>
              <div className="absolute bottom-2 right-2 flex items-center">
                <div className="bg-green-500 rounded-full w-3 h-3 mr-1"></div>
                <span className="text-xs">Ongoing</span>
              </div>
